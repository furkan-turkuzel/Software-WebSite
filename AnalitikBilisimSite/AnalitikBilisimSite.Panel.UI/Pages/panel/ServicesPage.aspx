<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/panel/Master.Master" AutoEventWireup="true" CodeBehind="ServicesPage.aspx.cs" Inherits="AnalitikBilisimSite.Panel.UI.Pages.panel.ServicesPage" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlSec" runat="server">
        <asp:Button ID="btnSecKaydet" runat="server" Text="Yeni Hizmet Ekle" Class="btn btn-large btn-block btn-success" OnClick="btnSecKaydet_Click" />
        <asp:Button ID="btnSecGuncelle" runat="server" Text="Hizmet Güncelle veya Sil" Class="btn btn-large btn-block btn-warning" OnClick="btnSecGuncelle_Click" />
    </asp:Panel>
            ...
            <div class="col-xs-12 col-sm-12">
                <div class="box">
                    ...
                    <div class="box-content">
                        <h4 class="page-header">Hizmetlerimiz Bilgileri</h4>
                        <div class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="col-sm-5">
                                        <a class="pull-right">
                                            <asp:Image ID="ImgService" runat="server" Width="200" Height="200" CssClass="img-thumbnail" /><br />
