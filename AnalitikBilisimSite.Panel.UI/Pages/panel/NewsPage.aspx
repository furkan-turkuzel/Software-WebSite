<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/panel/Master.Master" AutoEventWireup="true" CodeBehind="NewsPage.aspx.cs" Inherits="AnalitikBilisimSite.Panel.UI.Pages.panel.NewsPage" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlSec" runat="server">
        <asp:Button ID="btnSecKaydet" runat="server" Text="Yeni Haber Ekle" Class="btn btn-large btn-block btn-success" OnClick="btnSecKaydet_Click" />
        <asp:Button ID="btnSecGuncelle" runat="server" Text="Haber Güncelle veya Sil" Class="btn btn-large btn-block btn-warning" OnClick="btnSecGuncelle_Click" />
    </asp:Panel>
            ...
            <div class="col-xs-12 col-sm-12">
                <div class="box">
                    ...
                    <div class="box-content">
                        <h4 class="page-header">Haber Bilgileri</h4>
                        <div class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="col-sm-5">
                                        <a class="pull-right">
                                            <asp:Image ID="ImgNews" runat="server" Width="200" Height="200" CssClass="img-thumbnail" /><br />
                            ...
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Küçük Yazı Boş Bırakılamaz!" ControlToValidate="txtKucukYazi" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
                            <br />
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Büyük Yazı Boş Bırakılamaz!" ControlToValidate="txtBuyukYazi" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
                            <br />
    ...
    <script type="text/javascript">
        ...
        var furkan = 12;//document.getElementById("btnSilTable").getAttribute("CommandArgument");
        $document.getElementById('#<%=HiddenField1.ClientID %>').val(furkan)
    </script>
</asp:Content>
